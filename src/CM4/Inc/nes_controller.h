...
bool nes_controller_setup(struct nes_controller **controller, nes_controller_type controller_type,
...
bool nes_controller_destroy(struct nes_controller **controller);
