...
/**
  ...
  * @retval None
  */
void HAL_SD_AbortCallback(__attribute__((unused)) SD_HandleTypeDef *hsd)
{
...
/**
  ...
  * @retval None
  */
void HAL_SD_TxCpltCallback(__attribute__((unused)) SD_HandleTypeDef *hsd)
{
...
/**
  ...
  * @retval None
  */
void HAL_SD_RxCpltCallback(__attribute__((unused)) SD_HandleTypeDef *hsd)
{
