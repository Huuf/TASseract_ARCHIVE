...
WAIT_1_US:
    ...
    MOV     R0, R0 ;
    MOV     R0, R0 ;
    MOV     R0, R0 ;      // clock cycle 350
    MOV     R0, R0 ;
    MOV     R0, R0 ;

    SUBS    R0, R0, #1 ;     // clock cycle 351
    BGT     WAIT_1_US ;      // clock cycle 352
